    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(
            MarkerOptions().position(sena)
                .title("El SENA")
                .snippet("CENTRO TELEINFORMÁTICA Y PRODUCCIÓN INDUSTRIAL SENA - REGIONAL CAUCA.")
        )
        ...
        mMap.addMarker(
            MarkerOptions().position(morro)
                .title("El Morro")
                .snippet("El Morro del Tulcán o Pirámide de Tucán es el principal sitio arqueológico de Popayán. Este consiste en una pequeña loma no natural en forma de pirámide truncada, en la cual se encontraron elementos de la época precolombina, aproximadamente entre los años 500 – 1600 a")
        )
